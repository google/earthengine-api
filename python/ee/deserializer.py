...
def fromJSON(json_obj: str) -> Any:  # pylint: disable=g-bad-name
...
def fromCloudApiJSON(json_obj: str) -> Any:  # pylint: disable=g-bad-name
...
def decodeCloudApi(json_obj: dict[str, Any]) -> Any:  # pylint: disable=g-bad-name
