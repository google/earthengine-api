...
class Color(computedobject.ComputedObject):
  ...
  @staticmethod
  def fromHsv(hsv: _arg_types.List) -> Color:
  ...
  @staticmethod
  def fromHsl(hsl: _arg_types.List) -> Color:
    """Creates a Color given a list of HSL values.

    Args:
      hsl: A list of HSL (hue, saturation, luminosity) values in the range [0:1].
  ...
  @staticmethod
  def fromLab(lab: _arg_types.List) -> Color:
  ...
  @staticmethod
  def fromLch(lch: _arg_types.List) -> Color:
  ...
  @staticmethod
  def gray(value: _arg_types.Number, alpha: _arg_types.Number = 1.0) -> Color:
