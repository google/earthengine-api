...
class DataTest(unittest.TestCase):
  ...
  def test_get_pixels(self):
    ...
    with apitestcase.UsingCloudApi(
      ...
      (
          cloud_api_resource_raw.projects()
          .assets()
          .getPixels.assert_called_once_with(
  ...
  def test_set_asset_acl(self):
    ...
    with mock.patch.object(
      ...
      mock_convert.assert_called_with(acl_update_dict)
      mock_set_iam_policy.assert_called_with(asset_id, policy)
      self.assertEqual(1, mock_convert.call_count)
      self.assertEqual(1, mock_set_iam_policy.call_count)
