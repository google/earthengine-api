 ...
 * @param {!Array<number>=} opt_padding Shifts the color range by padding the end.
...
ee.Palette = function(
  ...
  if (opt_colors instanceof ee.ComputedObject && arguments.length == 1) {
    ...
    ee.Palette.base(
        this, 'constructor', new ee.ApiFunction('Palette'), {
          'colors': opt_colors,
          'mode': opt_mode || 'RGB',
 ...
 *
 * @param {number|!ee.Number} value The value to look up.
 * @return {!ee.Color}
 * @export
 */
 ...
 *
 * @param {(number|!ee.Number)=} opt_nColors The number of equally spaced colors
 *     to retrieve.
 * @return {!ee.List}
 * @export
 */
 ...
 *
 * @param {string|!ee.String} mode The colorspace mode.
 * @return {!ee.Palette}
 * @export
 */
 ...
 *
 * @param {number|!ee.Number} min The minimum value.
 * @param {number|!ee.Number} max The maximum value.
 * @return {!ee.Palette}
 * @export
 */
 ...
 *
 * @param {!Array<number>|!ee.List} positions A list of values specifying the
 ...
 *
 * @param {number|!Array<number>|!ee.Number|!ee.List} classes Either a list of
 *     class break values, or a single number.
 * @return {!ee.Palette}
 * @export
 */
 ...
 *
 * @param {number|!ee.Number} left The left padding.
 * @param {(number|!ee.Number)=} opt_right The right padding.
 * @return {!ee.Palette}
 * @export
 */
 ...
 *
 * @param {number|!ee.Number} gamma The gamma value.
 * @return {!ee.Palette}
 * @export
 */
 ...
 *
 * @param {(boolean|!ee.ComputedObject)=} opt_correct Whether to correct lightness.
 * @return {!ee.Palette}
 * @export
 */
