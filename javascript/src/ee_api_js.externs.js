...
var module$contents$ee$batch_Export;
 ...
 */
module$contents$ee$batch_Export.image.toAsset = function(image, opt_description, opt_assetId, opt_pyramidingPolicy, opt_dimensions, opt_region, opt_scale, opt_crs, opt_crsTransform, opt_maxPixels) {
};
/**
 * @param {!ee.Image} image
 * @param {string=} opt_description
...
module$contents$ee$batch_Export.map;
/**
 * @param {!ee.Image} image
 * @param {string=} opt_description
 * @param {string=} opt_bucket
...
var module$contents$ee$batch_ExportTask;
module$contents$ee$batch_ExportTask.prototype.id;
/**
 * @param {function(): ?=} opt_success
 * @param {function(string=): ?=} opt_error
 * @return {undefined}
