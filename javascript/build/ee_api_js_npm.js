...
required:!1}, prettyPrint:{location:"query", required:!1}, quotaUser:{location:"query", required:!1}, uploadType:{location:"query", required:!1}, upload_protocol:{location:"query", required:!1}}, resources:{projects:{methods:{getCapabilities:{id:"earthengine.projects.getCapabilities", path:"v1alpha/{+parent}/capabilities", httpMethod:"GET", parameters:{parent:{location:"path", required:!0}}}, listAssets:{id:"earthengine.projects.listAssets", path:"v1alpha/{+parent}:listAssets", httpMethod:"GET", 
...
ee.rpc_convert_batch.buildGridDimensions_ = function(dimensions) {
  ...
  goog.isString(dimensions) && (-1 !== dimensions.indexOf("x") ? dimensions = dimensions.split("x").map(Number) : -1 !== dimensions.indexOf(",") && (dimensions = dimensions.split(",").map(Number)));
...
jspb.BinaryWriter.prototype.getResultBase64String = function(alphabet) {
  !0 === alphabet ? alphabet = goog.crypt.base64.Alphabet.WEBSAFE_DOT_PADDING : !1 === alphabet && (alphabet = goog.crypt.base64.Alphabet.DEFAULT);
...
ee.data.TableType = {CSV:"CSV", SHAPE:"SHAPE", TF_RECORD:"TFRecord"};
...
ee.ComputedObject.prototype.encodeCloudValue = function(encoder) {
  if (this.isVariable()) {
    if (null === this.varName) {
      throw Error("Internal error: function argument not initialized.");
    }
  ...
  if (crsTransform) {
    if (image = ee.ApiFunction._apply("Image.reproject", {image:image, crs:crs, crsTransform:crsTransform}), goog.isDefAndNotNull(params.dimensions) && !goog.isDefAndNotNull(params.scale) && !goog.isDefAndNotNull(params.region)) {
      ...
      if (2 === dimensions.length) {
        ...
        params.region = new ee.Geometry.Rectangle([0, 0, dimensions[0], dimensions[1]], projection, !0);
      }
    }
  } else {
...
(function() {
  var exportedFnInfo = {}, orderedFnNames = "ee.data.startTableIngestion ee.Geometry.prototype.serialize ee.apply ee.data.getAssetRootQuota ee.Serializer.encode ee.data.authenticate ee.batch.Export.videoMap.toCloudStorage ee.Collection.prototype.filter ee.data.setAssetAcl ee.Image.prototype.getDownloadURL ee.Serializer.encodeCloudApiPretty ee.data.cancelOperation ee.data.makeThumbUrl ee.data.getDownloadId ee.Image ee.batch.Export.image.toCloudStorage ee.data.getFilmstripThumbId ee.FeatureCollection.prototype.getMap ee.InitState ee.FeatureCollection.prototype.getDownloadURL ee.data.setAssetProperties ee.data.setParamAugmenter ee.Filter.bounds ee.data.getList ee.Geometry.MultiPoint ee.Collection.prototype.limit ee.data.authenticateViaPrivateKey ee.data.authenticateViaPopup ee.data.getAuthToken ee.data.updateTask ee.data.getOperation ee.Image.prototype.expression ee.data.getInfo ee.ImageCollection.prototype.select ee.data.setDeadline ee.data.listBuckets ee.Filter.or ee.call ee.data.authenticateViaOauth ee.reset ee.Image.prototype.getMap ee.Filter.gte ee.batch.Export.image.toDrive ee.data.setExpressionAugmenter ee.Filter.gt ee.data.newTaskId ee.Geometry.Point ee.data.makeTableDownloadUrl ee.ApiFunction.lookup ee.data.setCloudApiEnabled ee.ImageCollection.prototype.getMap ee.Geometry.MultiPolygon ee.Number ee.Filter.inList ee.batch.Export.image.toAsset ee.Function.prototype.call ee.data.getTileUrl ee.batch.Export.map.toCloudStorage ee.data.getTileBaseUrl ee.data.getXsrfToken ee.data.getThumbId ee.Image.prototype.clip ee.String ee.data.startIngestion ee.Collection.prototype.filterMetadata ee.ImageCollection.prototype.getVideoThumbURL ee.data.getValue ee.data.getAuthScopes ee.Geometry.Rectangle ee.Geometry.prototype.toGeoJSONString ee.Function.prototype.apply ee.Filter.date ee.data.createAssetHome ee.data.renameAsset ee.Filter.lt ee.Feature.prototype.getMap ee.data.getTaskListWithLimit ee.data.getMapId ee.data.getAuthClientId ee.Geometry.MultiLineString ee.data.createAsset ee.batch.Export.table.toDrive ee.data.setApiKey ee.Geometry.LinearRing ee.Geometry.Polygon ee.Serializer.encodeCloudApi ee.FeatureCollection ee.Image.prototype.getInfo ee.data.createFolder ee.Filter.eq ee.data.getAssetAcl ee.ComputedObject.prototype.aside ee.Terrain ee.data.getApiBaseUrl ee.Geometry.LineString ee.data.clearAuthToken ee.batch.Export.video.toDrive ee.Image.cat ee.data.withProfiling ee.Filter.and ee.data.updateAsset ee.ComputedObject.prototype.serialize ee.initialize ee.data.getTableDownloadId ee.List ee.Collection.prototype.sort ee.ImageCollection ee.Deserializer.fromJSON ee.data.setAuthTokenRefresher ee.Filter.neq ee.Image.rgb ee.Date ee.data.getTaskList ee.Feature.prototype.getInfo ee.FeatureCollection.prototype.select ee.Element.prototype.set ee.Collection.prototype.filterBounds ee.ImageCollection.prototype.getInfo ee.data.listAssets ee.data.setAuthToken ee.ApiFunction._call ee.Collection.prototype.filterDate ee.Filter ee.batch.Export.table.toCloudStorage ee.Geometry ee.data.getCloudApiEnabled ee.Collection.prototype.iterate ee.Filter.lte ee.ApiFunction._apply ee.data.setProject ee.data.makeDownloadUrl ee.ComputedObject.prototype.evaluate ee.Filter.prototype.not ee.Geometry.prototype.toGeoJSON ee.Serializer.toReadableJSON ee.Image.prototype.getThumbURL ee.data.cancelTask ee.data.getAssetRoots ee.data.listImages ee.Algorithms ee.Serializer.toReadableCloudApiJSON ee.data.getTaskStatus ee.TILE_SIZE ee.data.getAsset ee.ImageCollection.prototype.first ee.Serializer.toJSON ee.Collection.prototype.map ee.ImageCollection.prototype.getFilmstripThumbURL ee.batch.Export.video.toCloudStorage ee.Feature ee.Filter.metadata ee.Image.prototype.select ee.data.getVideoThumbId ee.FeatureCollection.prototype.getInfo ee.Dictionary ee.data.copyAsset ee.data.startProcessing ee.ComputedObject.prototype.getInfo ee.Image.prototype.rename ee.data.deleteAsset ee.batch.Export.table.toAsset ee.Deserializer.decode".split(" "), 
  orderedParamLists = [["taskId", "request", "opt_callback"], [], ["func", "namedArgs"], ["rootId", "opt_callback"], ["obj", "opt_isCompound"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_writePublicTiles opt_minZoom opt_maxZoom opt_scale opt_region opt_skipEmptyTiles".split(" "), ["filter"], ["assetId", "aclUpdate", "opt_callback"], ["params", "opt_callback"], ["obj"], ["operationName", 
  "opt_callback"], ["id"], ["params", "opt_callback"], ["opt_args"], "image opt_description opt_bucket opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["params", "opt_callback"], ["opt_visParams", "opt_callback"], [], ["opt_format", "opt_selectors", "opt_filename", "opt_callback"], ["assetId", "properties", "opt_callback"], ["augmenter"], ["geometry", "opt_errorMargin"], 
  ["params", "opt_callback"], ["coords", "opt_proj"], ["max", "opt_property", "opt_ascending"], ["privateKey", "opt_success", "opt_error", "opt_extraScopes"], ["opt_success", "opt_error"], [], ["taskId", "action", "opt_callback"], ["operationName", "opt_callback"], ["expression", "opt_map"], ["id", "opt_callback"], ["selectors", "opt_names"], ["milliseconds"], ["opt_callback"], ["var_args"], ["func", "var_args"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], [], 
  ["opt_visParams", "opt_callback"], ["name", "value"], "image opt_description opt_folder opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["augmenter"], ["name", "value"], ["opt_count", "opt_callback"], ["coords", "opt_proj"], ["id"], ["name"], ["enable"], ["opt_visParams", "opt_callback"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], 
  ["number"], ["opt_leftField", "opt_rightValue", "opt_rightField", "opt_leftValue"], "image opt_description opt_assetId opt_pyramidingPolicy opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels".split(" "), ["var_args"], ["mapid", "x", "y", "z"], "image opt_description opt_bucket opt_fileFormat opt_path opt_writePublicTiles opt_scale opt_maxZoom opt_minZoom opt_region opt_skipEmptyTiles opt_mapsApiKey".split(" "), [], [], ["params", "opt_callback"], ["geometry"], ["string"], 
  ["taskId", "request", "opt_callback"], ["name", "operator", "value"], ["params", "opt_callback"], ["params", "opt_callback"], [], ["coords", "opt_proj", "opt_geodesic", "opt_evenOdd"], [], ["namedArgs"], ["start", "opt_end"], ["requestedId", "opt_callback"], ["sourceId", "destinationId", "opt_callback"], ["name", "value"], ["opt_visParams", "opt_callback"], ["opt_limit", "opt_callback"], ["params", "opt_callback"], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["value", "opt_path", 
  "opt_force", "opt_properties", "opt_callback"], "collection opt_description opt_folder opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), ["apiKey"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["obj"], ["args", "opt_column"], ["opt_callback"], ["path", "opt_force", "opt_callback"], ["name", "value"], ["assetId", "opt_callback"], ["func", "var_args"], [], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], 
  [], "collection opt_description opt_folder opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), ["var_args"], ["hook", "body", "opt_this"], ["var_args"], ["assetId", "asset", "updateMask", "opt_callback"], [], ["opt_baseurl", "opt_tileurl", "opt_successCallback", "opt_errorCallback", "opt_xsrfToken"], ["params", "opt_callback"], ["list"], ["property", "opt_ascending"], ["args"], ["json"], ["refresher"], ["name", 
  "value"], ["r", "g", "b"], ["date", "opt_tz"], ["opt_callback"], ["opt_callback"], ["propertySelectors", "opt_newProperties", "opt_retainGeometry"], ["var_args"], ["geometry"], ["opt_callback"], ["body", "opt_callback"], "clientId tokenType accessToken expiresIn opt_extraScopes opt_callback opt_updateAuthLibrary".split(" "), ["name", "var_args"], ["start", "opt_end"], ["opt_filter"], "collection opt_description opt_bucket opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), ["geoJson", 
  "opt_proj", "opt_geodesic", "opt_evenOdd"], [], ["algorithm", "opt_first"], ["name", "value"], ["name", "namedArgs"], ["project"], ["id"], ["callback"], [], [], ["obj"], ["params", "opt_callback"], ["taskId", "opt_callback"], ["opt_callback"], ["body", "opt_callback"], [], ["obj"], ["taskId", "opt_callback"], [], ["id", "opt_callback"], [], ["obj"], ["algorithm", "opt_dropNulls"], ["params", "opt_callback"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), 
  ["geometry", "opt_properties"], ["name", "operator", "value"], ["var_args"], ["params", "opt_callback"], ["opt_callback"], ["opt_dict"], ["sourceId", "destinationId", "opt_overwrite", "opt_callback"], ["taskId", "params", "opt_callback"], ["opt_callback"], ["var_args"], ["assetId", "opt_callback"], ["collection", "opt_description", "opt_assetId"], ["json"]];
  [ee.data.startTableIngestion, ee.Geometry.prototype.serialize, ee.apply, ee.data.getAssetRootQuota, ee.Serializer.encode, ee.data.authenticate, ee.batch.Export.videoMap.toCloudStorage, ee.Collection.prototype.filter, ee.data.setAssetAcl, ee.Image.prototype.getDownloadURL, ee.Serializer.encodeCloudApiPretty, ee.data.cancelOperation, ee.data.makeThumbUrl, ee.data.getDownloadId, ee.Image, ee.batch.Export.image.toCloudStorage, ee.data.getFilmstripThumbId, ee.FeatureCollection.prototype.getMap, ee.InitState, 
  ee.FeatureCollection.prototype.getDownloadURL, ee.data.setAssetProperties, ee.data.setParamAugmenter, ee.Filter.bounds, ee.data.getList, ee.Geometry.MultiPoint, ee.Collection.prototype.limit, ee.data.authenticateViaPrivateKey, ee.data.authenticateViaPopup, ee.data.getAuthToken, ee.data.updateTask, ee.data.getOperation, ee.Image.prototype.expression, ee.data.getInfo, ee.ImageCollection.prototype.select, ee.data.setDeadline, ee.data.listBuckets, ee.Filter.or, ee.call, ee.data.authenticateViaOauth, 
  ee.reset, ee.Image.prototype.getMap, ee.Filter.gte, ee.batch.Export.image.toDrive, ee.data.setExpressionAugmenter, ee.Filter.gt, ee.data.newTaskId, ee.Geometry.Point, ee.data.makeTableDownloadUrl, ee.ApiFunction.lookup, ee.data.setCloudApiEnabled, ee.ImageCollection.prototype.getMap, ee.Geometry.MultiPolygon, ee.Number, ee.Filter.inList, ee.batch.Export.image.toAsset, ee.Function.prototype.call, ee.data.getTileUrl, ee.batch.Export.map.toCloudStorage, ee.data.getTileBaseUrl, ee.data.getXsrfToken, 
  ee.data.getThumbId, ee.Image.prototype.clip, ee.String, ee.data.startIngestion, ee.Collection.prototype.filterMetadata, ee.ImageCollection.prototype.getVideoThumbURL, ee.data.getValue, ee.data.getAuthScopes, ee.Geometry.Rectangle, ee.Geometry.prototype.toGeoJSONString, ee.Function.prototype.apply, ee.Filter.date, ee.data.createAssetHome, ee.data.renameAsset, ee.Filter.lt, ee.Feature.prototype.getMap, ee.data.getTaskListWithLimit, ee.data.getMapId, ee.data.getAuthClientId, ee.Geometry.MultiLineString, 
  ee.data.createAsset, ee.batch.Export.table.toDrive, ee.data.setApiKey, ee.Geometry.LinearRing, ee.Geometry.Polygon, ee.Serializer.encodeCloudApi, ee.FeatureCollection, ee.Image.prototype.getInfo, ee.data.createFolder, ee.Filter.eq, ee.data.getAssetAcl, ee.ComputedObject.prototype.aside, ee.Terrain, ee.data.getApiBaseUrl, ee.Geometry.LineString, ee.data.clearAuthToken, ee.batch.Export.video.toDrive, ee.Image.cat, ee.data.withProfiling, ee.Filter.and, ee.data.updateAsset, ee.ComputedObject.prototype.serialize, 
  ee.initialize, ee.data.getTableDownloadId, ee.List, ee.Collection.prototype.sort, ee.ImageCollection, ee.Deserializer.fromJSON, ee.data.setAuthTokenRefresher, ee.Filter.neq, ee.Image.rgb, ee.Date, ee.data.getTaskList, ee.Feature.prototype.getInfo, ee.FeatureCollection.prototype.select, ee.Element.prototype.set, ee.Collection.prototype.filterBounds, ee.ImageCollection.prototype.getInfo, ee.data.listAssets, ee.data.setAuthToken, ee.ApiFunction._call, ee.Collection.prototype.filterDate, ee.Filter, 
  ee.batch.Export.table.toCloudStorage, ee.Geometry, ee.data.getCloudApiEnabled, ee.Collection.prototype.iterate, ee.Filter.lte, ee.ApiFunction._apply, ee.data.setProject, ee.data.makeDownloadUrl, ee.ComputedObject.prototype.evaluate, ee.Filter.prototype.not, ee.Geometry.prototype.toGeoJSON, ee.Serializer.toReadableJSON, ee.Image.prototype.getThumbURL, ee.data.cancelTask, ee.data.getAssetRoots, ee.data.listImages, ee.Algorithms, ee.Serializer.toReadableCloudApiJSON, ee.data.getTaskStatus, ee.TILE_SIZE, 
  ee.data.getAsset, ee.ImageCollection.prototype.first, ee.Serializer.toJSON, ee.Collection.prototype.map, ee.ImageCollection.prototype.getFilmstripThumbURL, ee.batch.Export.video.toCloudStorage, ee.Feature, ee.Filter.metadata, ee.Image.prototype.select, ee.data.getVideoThumbId, ee.FeatureCollection.prototype.getInfo, ee.Dictionary, ee.data.copyAsset, ee.data.startProcessing, ee.ComputedObject.prototype.getInfo, ee.Image.prototype.rename, ee.data.deleteAsset, ee.batch.Export.table.toAsset, ee.Deserializer.decode].forEach(function(fn, 
  i) {
