...
ee.data.computeValue = function(obj, opt_callback) {
  if (ee.data.cloudApiEnabled_) {
    ...
    return ee.data.sendCloudApiRequest_(function() {
      return gapi.client.earthengine.v1.computeValue({expression:expression});
    }, function(x) {
      return x.result;
    }, opt_callback);
  }
...
(function() {
  var exportedFnInfo = {}, orderedFnNames = "ee.Filter.or ee.FeatureCollection.prototype.getDownloadURL ee.Geometry.LinearRing ee.Collection.prototype.filterBounds ee.Filter.gt ee.ComputedObject.prototype.evaluate ee.data.setApiKey ee.ApiFunction.lookup ee.InitState ee.Image ee.batch.Export.map.toCloudStorage ee.Geometry.prototype.toGeoJSONString ee.ApiFunction._call ee.FeatureCollection.prototype.getInfo ee.data.clearAuthToken ee.batch.Export.table.toAsset ee.Image.prototype.select ee.apply ee.Collection.prototype.iterate ee.data.getList ee.Date ee.initialize ee.data.getInfo ee.batch.Export.video.toCloudStorage ee.Geometry.LineString ee.batch.Export.table.toDrive ee.data.getXsrfToken ee.Filter.neq ee.Filter.metadata ee.data.getTileBaseUrl ee.Feature.prototype.getMap ee.data.listAssets ee.batch.Export.table.toCloudStorage ee.Filter.eq ee.data.makeTableDownloadUrl ee.ImageCollection.prototype.getAnimatedThumbURL ee.List ee.data.listImages ee.ImageCollection ee.Geometry.Rectangle ee.TILE_SIZE ee.Number ee.ImageCollection.prototype.getInfo ee.Filter.date ee.Serializer.encodeCloudApi ee.Filter.lt ee.Image.prototype.getDownloadURL ee.Feature.prototype.getInfo ee.Collection.prototype.map ee.Terrain ee.Algorithms ee.Collection.prototype.filter ee.ImageCollection.prototype.first ee.Geometry.MultiPoint ee.data.authenticateViaOauth ee.Geometry ee.data.getThumbId ee.Serializer.encodeCloudApiPretty ee.Function.prototype.apply ee.FeatureCollection.prototype.select ee.Image.rgb ee.data.makeThumbUrl ee.ImageCollection.prototype.getTiledThumbURL ee.Filter.gte ee.data.makeDownloadUrl ee.data.getTableDownloadId ee.Image.prototype.rename ee.data.setDeadline ee.Filter.inList ee.Image.cat ee.batch.Export.image.toDrive ee.data.getMapId ee.Serializer.encode ee.batch.Export.videoMap.toCloudStorage ee.batch.Export.video.toDrive ee.batch.Export.image.toCloudStorage ee.data.authenticateViaPrivateKey ee.data.getAuthScopes ee.Serializer.toReadableJSON ee.data.getTileUrl ee.batch.Export.image.toAsset ee.ImageCollection.prototype.select ee.ComputedObject.prototype.aside ee.data.getCloudApiEnabled ee.reset ee.Geometry.MultiPolygon ee.String ee.data.getAsset ee.ComputedObject.prototype.serialize ee.Feature ee.data.authenticate ee.Collection.prototype.sort ee.data.setAuthTokenRefresher ee.Serializer.toJSON ee.Image.prototype.getMap ee.FeatureCollection.prototype.getMap ee.Serializer.toReadableCloudApiJSON ee.Image.prototype.clip ee.Filter.prototype.not ee.Geometry.Polygon ee.data.listBuckets ee.data.setAuthToken ee.Collection.prototype.filterDate ee.data.authenticateViaPopup ee.Function.prototype.call ee.FeatureCollection ee.data.getDownloadId ee.ComputedObject.prototype.getInfo ee.Image.prototype.getInfo ee.ApiFunction._apply ee.Dictionary ee.Collection.prototype.limit ee.Geometry.prototype.toGeoJSON ee.Element.prototype.set ee.data.getApiBaseUrl ee.Geometry.MultiLineString ee.data.setCloudApiEnabled ee.Filter ee.Filter.and ee.Deserializer.decode ee.Image.prototype.expression ee.Geometry.prototype.serialize ee.Filter.bounds ee.data.getValue ee.data.getAuthToken ee.ImageCollection.prototype.getMap ee.Collection.prototype.filterMetadata ee.Deserializer.fromJSON ee.Filter.lte ee.data.getAuthClientId ee.Geometry.Point ee.Image.prototype.getThumbURL ee.call".split(" "), 
  orderedParamLists = [["var_args"], ["opt_format", "opt_selectors", "opt_filename", "opt_callback"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["geometry"], ["name", "value"], ["callback"], ["apiKey"], ["name"], [], ["opt_args"], "image opt_description opt_bucket opt_fileFormat opt_path opt_writePublicTiles opt_scale opt_maxZoom opt_minZoom opt_region opt_skipEmptyTiles opt_mapsApiKey".split(" "), [], ["name", "var_args"], ["opt_callback"], [], ["collection", "opt_description", "opt_assetId"], 
  ["var_args"], ["func", "namedArgs"], ["algorithm", "opt_first"], ["params", "opt_callback"], ["date", "opt_tz"], ["opt_baseurl", "opt_tileurl", "opt_successCallback", "opt_errorCallback", "opt_xsrfToken"], ["id", "opt_callback"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], "collection opt_description opt_folder opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), 
  [], ["name", "value"], ["name", "operator", "value"], [], ["opt_visParams", "opt_callback"], ["body", "opt_callback"], "collection opt_description opt_bucket opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), ["name", "value"], ["id"], ["params", "opt_callback"], ["list"], ["body", "opt_callback"], ["args"], ["coords", "opt_proj", "opt_geodesic", "opt_evenOdd"], [], ["number"], ["opt_callback"], ["start", "opt_end"], ["obj"], ["name", "value"], ["params", "opt_callback"], ["opt_callback"], 
  ["algorithm", "opt_dropNulls"], [], [], ["filter"], [], ["coords", "opt_proj"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], ["geoJson", "opt_proj", "opt_geodesic", "opt_evenOdd"], ["params", "opt_callback"], ["obj"], ["namedArgs"], ["propertySelectors", "opt_newProperties", "opt_retainGeometry"], ["r", "g", "b"], ["id"], ["params", "opt_callback"], ["name", "value"], ["id"], ["params", "opt_callback"], ["var_args"], ["milliseconds"], ["opt_leftField", "opt_rightValue", 
  "opt_rightField", "opt_leftValue"], ["var_args"], "image opt_description opt_folder opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["params", "opt_callback"], ["obj", "opt_isCompound"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_writePublicTiles opt_minZoom opt_maxZoom opt_scale opt_region opt_skipEmptyTiles".split(" "), 
  "collection opt_description opt_folder opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), "image opt_description opt_bucket opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["privateKey", "opt_success", "opt_error", "opt_extraScopes"], [], ["obj"], ["mapid", "x", "y", 
  "z"], "image opt_description opt_assetId opt_pyramidingPolicy opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels".split(" "), ["selectors", "opt_names"], ["func", "var_args"], [], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["string"], ["id", "opt_callback"], [], ["geometry", "opt_properties"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], ["property", "opt_ascending"], ["refresher"], ["obj"], ["opt_visParams", 
  "opt_callback"], ["opt_visParams", "opt_callback"], ["obj"], ["geometry"], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["opt_callback"], "clientId tokenType accessToken expiresIn opt_extraScopes opt_callback opt_updateAuthLibrary".split(" "), ["start", "opt_end"], ["opt_success", "opt_error"], ["var_args"], ["args", "opt_column"], ["params", "opt_callback"], ["opt_callback"], ["opt_callback"], ["name", "namedArgs"], ["opt_dict"], ["max", "opt_property", "opt_ascending"], 
  [], ["var_args"], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["enable"], ["opt_filter"], ["var_args"], ["json"], ["expression", "opt_map"], [], ["geometry", "opt_errorMargin"], ["params", "opt_callback"], [], ["opt_visParams", "opt_callback"], ["name", "operator", "value"], ["json"], ["name", "value"], [], ["coords", "opt_proj"], ["params", "opt_callback"], ["func", "var_args"]];
  [ee.Filter.or, ee.FeatureCollection.prototype.getDownloadURL, ee.Geometry.LinearRing, ee.Collection.prototype.filterBounds, ee.Filter.gt, ee.ComputedObject.prototype.evaluate, ee.data.setApiKey, ee.ApiFunction.lookup, ee.InitState, ee.Image, ee.batch.Export.map.toCloudStorage, ee.Geometry.prototype.toGeoJSONString, ee.ApiFunction._call, ee.FeatureCollection.prototype.getInfo, ee.data.clearAuthToken, ee.batch.Export.table.toAsset, ee.Image.prototype.select, ee.apply, ee.Collection.prototype.iterate, 
  ee.data.getList, ee.Date, ee.initialize, ee.data.getInfo, ee.batch.Export.video.toCloudStorage, ee.Geometry.LineString, ee.batch.Export.table.toDrive, ee.data.getXsrfToken, ee.Filter.neq, ee.Filter.metadata, ee.data.getTileBaseUrl, ee.Feature.prototype.getMap, ee.data.listAssets, ee.batch.Export.table.toCloudStorage, ee.Filter.eq, ee.data.makeTableDownloadUrl, ee.ImageCollection.prototype.getAnimatedThumbURL, ee.List, ee.data.listImages, ee.ImageCollection, ee.Geometry.Rectangle, ee.TILE_SIZE, 
  ee.Number, ee.ImageCollection.prototype.getInfo, ee.Filter.date, ee.Serializer.encodeCloudApi, ee.Filter.lt, ee.Image.prototype.getDownloadURL, ee.Feature.prototype.getInfo, ee.Collection.prototype.map, ee.Terrain, ee.Algorithms, ee.Collection.prototype.filter, ee.ImageCollection.prototype.first, ee.Geometry.MultiPoint, ee.data.authenticateViaOauth, ee.Geometry, ee.data.getThumbId, ee.Serializer.encodeCloudApiPretty, ee.Function.prototype.apply, ee.FeatureCollection.prototype.select, ee.Image.rgb, 
  ee.data.makeThumbUrl, ee.ImageCollection.prototype.getTiledThumbURL, ee.Filter.gte, ee.data.makeDownloadUrl, ee.data.getTableDownloadId, ee.Image.prototype.rename, ee.data.setDeadline, ee.Filter.inList, ee.Image.cat, ee.batch.Export.image.toDrive, ee.data.getMapId, ee.Serializer.encode, ee.batch.Export.videoMap.toCloudStorage, ee.batch.Export.video.toDrive, ee.batch.Export.image.toCloudStorage, ee.data.authenticateViaPrivateKey, ee.data.getAuthScopes, ee.Serializer.toReadableJSON, ee.data.getTileUrl, 
  ee.batch.Export.image.toAsset, ee.ImageCollection.prototype.select, ee.ComputedObject.prototype.aside, ee.data.getCloudApiEnabled, ee.reset, ee.Geometry.MultiPolygon, ee.String, ee.data.getAsset, ee.ComputedObject.prototype.serialize, ee.Feature, ee.data.authenticate, ee.Collection.prototype.sort, ee.data.setAuthTokenRefresher, ee.Serializer.toJSON, ee.Image.prototype.getMap, ee.FeatureCollection.prototype.getMap, ee.Serializer.toReadableCloudApiJSON, ee.Image.prototype.clip, ee.Filter.prototype.not, 
  ee.Geometry.Polygon, ee.data.listBuckets, ee.data.setAuthToken, ee.Collection.prototype.filterDate, ee.data.authenticateViaPopup, ee.Function.prototype.call, ee.FeatureCollection, ee.data.getDownloadId, ee.ComputedObject.prototype.getInfo, ee.Image.prototype.getInfo, ee.ApiFunction._apply, ee.Dictionary, ee.Collection.prototype.limit, ee.Geometry.prototype.toGeoJSON, ee.Element.prototype.set, ee.data.getApiBaseUrl, ee.Geometry.MultiLineString, ee.data.setCloudApiEnabled, ee.Filter, ee.Filter.and, 
  ee.Deserializer.decode, ee.Image.prototype.expression, ee.Geometry.prototype.serialize, ee.Filter.bounds, ee.data.getValue, ee.data.getAuthToken, ee.ImageCollection.prototype.getMap, ee.Collection.prototype.filterMetadata, ee.Deserializer.fromJSON, ee.Filter.lte, ee.data.getAuthClientId, ee.Geometry.Point, ee.Image.prototype.getThumbURL, ee.call].forEach(function(fn, i) {
