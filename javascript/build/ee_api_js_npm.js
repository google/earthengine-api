...
ee.rpc_convert.toOnePlatformSource = function(source) {
  ...
  if (source.primaryPath) {
    ...
    delete convertedSource.primaryPath;
    delete convertedSource.additionalPaths;
  }
  convertedSource.maxError && (convertedSource.maxErrorMeters = convertedSource.maxError, delete convertedSource.maxError);
...
ExpressionOptimizer.prototype.optimizeValue = function(value, depth) {
  ...
  if (goog.isDefAndNotNull(value.functionInvocationValue)) {
    for (var inv = value.functionInvocationValue, args = {}, $jscomp$iter$9 = $jscomp.makeIterator(Object.keys(inv.arguments || {})), $jscomp$key$k = $jscomp$iter$9.next(); !$jscomp$key$k.done; $jscomp$key$k = $jscomp$iter$9.next()) {
      ...
      args[k$17] = this.optimizeValue(inv.arguments[k$17], depth + 3);
    }
...
(function() {
  var exportedFnInfo = {}, orderedFnNames = "ee.data.getXsrfToken ee.Geometry.LinearRing ee.ImageCollection.prototype.getMap ee.data.listImages ee.data.getThumbId ee.Dictionary ee.Geometry.prototype.toGeoJSONString ee.batch.Export.table.toCloudStorage ee.data.getTaskListWithLimit ee.Geometry.Polygon ee.initialize ee.data.startProcessing ee.Deserializer.decode ee.data.newTaskId ee.ComputedObject.prototype.aside ee.ApiFunction.lookup ee.Function.prototype.apply ee.Image.prototype.getMap ee.ImageCollection.prototype.getInfo ee.data.createAssetHome ee.Filter.or ee.Image.prototype.select ee.data.authenticateViaOauth ee.Collection.prototype.filter ee.Filter.metadata ee.List ee.Geometry.LineString ee.data.getTaskStatus ee.FeatureCollection.prototype.getMap ee.data.clearAuthToken ee.FeatureCollection.prototype.getInfo ee.Feature.prototype.getInfo ee.data.setCloudApiEnabled ee.Image.prototype.getDownloadURL ee.data.getCloudApiEnabled ee.Collection.prototype.map ee.Filter.gt ee.ApiFunction._apply ee.ImageCollection.prototype.select ee.data.getTileUrl ee.batch.Export.video.toDrive ee.batch.Export.image.toDrive ee.data.getList ee.data.getDownloadId ee.ImageCollection.prototype.getVideoThumbURL ee.Terrain ee.Collection.prototype.limit ee.data.authenticate ee.data.getAuthScopes ee.Deserializer.fromJSON ee.data.getVideoThumbId ee.String ee.Date ee.batch.Export.videoMap.toCloudStorage ee.Serializer.encodeCloudApiPretty ee.data.createFolder ee.batch.Export.table.toAsset ee.data.startTableIngestion ee.data.setDeadline ee.Filter.and ee.data.getAssetRoots ee.Geometry.prototype.toGeoJSON ee.data.getAsset ee.Filter.lte ee.data.getAuthClientId ee.ComputedObject.prototype.serialize ee.Filter.eq ee.Algorithms ee.Geometry.MultiPoint ee.Image.prototype.rename ee.data.getValue ee.data.getMapId ee.data.updateAsset ee.data.copyAsset ee.Function.prototype.call ee.ImageCollection ee.FeatureCollection ee.data.makeTableDownloadUrl ee.data.cancelOperation ee.InitState ee.data.setApiKey ee.Serializer.toReadableJSON ee.Geometry.Rectangle ee.Filter.lt ee.data.createAsset ee.data.withProfiling ee.ComputedObject.prototype.getInfo ee.Number ee.batch.Export.image.toAsset ee.data.setParamAugmenter ee.Image.cat ee.data.listAssets ee.Filter.prototype.not ee.Collection.prototype.filterMetadata ee.data.updateTask ee.data.setProject ee.data.getTileBaseUrl ee.Image ee.data.makeDownloadUrl ee.ImageCollection.prototype.first ee.data.getTableDownloadId ee.data.makeThumbUrl ee.Filter.bounds ee.data.setAuthTokenRefresher ee.data.setAuthToken ee.Image.prototype.expression ee.data.getTaskList ee.data.authenticateViaPrivateKey ee.Collection.prototype.iterate ee.data.getInfo ee.data.getAuthToken ee.Filter.gte ee.Image.rgb ee.FeatureCollection.prototype.getDownloadURL ee.ComputedObject.prototype.evaluate ee.batch.Export.map.toCloudStorage ee.batch.Export.video.toCloudStorage ee.batch.Export.table.toDrive ee.data.getFilmstripThumbId ee.data.listBuckets ee.TILE_SIZE ee.reset ee.Geometry.MultiPolygon ee.Collection.prototype.filterBounds ee.data.getOperation ee.data.getAssetRootQuota ee.Geometry.MultiLineString ee.Element.prototype.set ee.Feature.prototype.getMap ee.data.setAssetAcl ee.data.cancelTask ee.Serializer.encodeCloudApi ee.Image.prototype.clip ee.Image.prototype.getThumbURL ee.ApiFunction._call ee.Image.prototype.getInfo ee.Feature ee.Geometry.Point ee.Serializer.encode ee.Geometry.prototype.serialize ee.call ee.data.getApiBaseUrl ee.Filter.date ee.Collection.prototype.sort ee.Filter.inList ee.Collection.prototype.filterDate ee.data.getAssetAcl ee.data.setExpressionAugmenter ee.batch.Export.image.toCloudStorage ee.Serializer.toReadableCloudApiJSON ee.data.authenticateViaPopup ee.apply ee.ImageCollection.prototype.getFilmstripThumbURL ee.Filter.neq ee.data.deleteAsset ee.FeatureCollection.prototype.select ee.Geometry ee.data.setAssetProperties ee.data.renameAsset ee.data.startIngestion ee.Serializer.toJSON ee.Filter".split(" "), 
  orderedParamLists = [[], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["opt_visParams", "opt_callback"], ["body", "opt_callback"], ["params", "opt_callback"], ["opt_dict"], [], "collection opt_description opt_bucket opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), ["opt_limit", "opt_callback"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["opt_baseurl", "opt_tileurl", "opt_successCallback", "opt_errorCallback", "opt_xsrfToken"], ["taskId", "params", 
  "opt_callback"], ["json"], ["opt_count", "opt_callback"], ["func", "var_args"], ["name"], ["namedArgs"], ["opt_visParams", "opt_callback"], ["opt_callback"], ["requestedId", "opt_callback"], ["var_args"], ["var_args"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], ["filter"], ["name", "operator", "value"], ["list"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["taskId", "opt_callback"], ["opt_visParams", "opt_callback"], [], ["opt_callback"], ["opt_callback"], 
  ["enable"], ["params", "opt_callback"], [], ["algorithm", "opt_dropNulls"], ["name", "value"], ["name", "namedArgs"], ["selectors", "opt_names"], ["mapid", "x", "y", "z"], "collection opt_description opt_folder opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), "image opt_description opt_folder opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), 
  ["params", "opt_callback"], ["params", "opt_callback"], ["params", "opt_callback"], [], ["max", "opt_property", "opt_ascending"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], [], ["json"], ["params", "opt_callback"], ["string"], ["date", "opt_tz"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_writePublicTiles opt_minZoom opt_maxZoom opt_scale opt_region opt_skipEmptyTiles".split(" "), ["obj"], ["path", "opt_force", "opt_callback"], 
  ["collection", "opt_description", "opt_assetId"], ["taskId", "request", "opt_callback"], ["milliseconds"], ["var_args"], ["opt_callback"], [], ["id", "opt_callback"], ["name", "value"], [], [], ["name", "value"], [], ["coords", "opt_proj"], ["var_args"], ["params", "opt_callback"], ["params", "opt_callback"], ["assetId", "asset", "updateMask", "opt_callback"], ["sourceId", "destinationId", "opt_overwrite", "opt_callback"], ["var_args"], ["args"], ["args", "opt_column"], ["id"], ["operationName", 
  "opt_callback"], [], ["apiKey"], ["obj"], ["coords", "opt_proj", "opt_geodesic", "opt_evenOdd"], ["name", "value"], ["value", "opt_path", "opt_force", "opt_properties", "opt_callback"], ["hook", "body", "opt_this"], ["opt_callback"], ["number"], "image opt_description opt_assetId opt_pyramidingPolicy opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels".split(" "), ["augmenter"], ["var_args"], ["body", "opt_callback"], [], ["name", "operator", "value"], ["taskId", "action", 
  "opt_callback"], ["project"], [], ["opt_args"], ["id"], [], ["params", "opt_callback"], ["id"], ["geometry", "opt_errorMargin"], ["refresher"], "clientId tokenType accessToken expiresIn opt_extraScopes opt_callback opt_updateAuthLibrary".split(" "), ["expression", "opt_map"], ["opt_callback"], ["privateKey", "opt_success", "opt_error", "opt_extraScopes"], ["algorithm", "opt_first"], ["id", "opt_callback"], [], ["name", "value"], ["r", "g", "b"], ["opt_format", "opt_selectors", "opt_filename", "opt_callback"], 
  ["callback"], "image opt_description opt_bucket opt_fileFormat opt_path opt_writePublicTiles opt_scale opt_maxZoom opt_minZoom opt_region opt_skipEmptyTiles opt_mapsApiKey".split(" "), "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), "collection opt_description opt_folder opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), ["params", "opt_callback"], ["opt_callback"], 
  [], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["geometry"], ["operationName", "opt_callback"], ["rootId", "opt_callback"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["var_args"], ["opt_visParams", "opt_callback"], ["assetId", "aclUpdate", "opt_callback"], ["taskId", "opt_callback"], ["obj"], ["geometry"], ["params", "opt_callback"], ["name", "var_args"], ["opt_callback"], ["geometry", "opt_properties"], ["coords", "opt_proj"], ["obj", "opt_isCompound"], 
  [], ["func", "var_args"], [], ["start", "opt_end"], ["property", "opt_ascending"], ["opt_leftField", "opt_rightValue", "opt_rightField", "opt_leftValue"], ["start", "opt_end"], ["assetId", "opt_callback"], ["augmenter"], "image opt_description opt_bucket opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["obj"], ["opt_success", "opt_error"], ["func", "namedArgs"], 
  ["params", "opt_callback"], ["name", "value"], ["assetId", "opt_callback"], ["propertySelectors", "opt_newProperties", "opt_retainGeometry"], ["geoJson", "opt_proj", "opt_geodesic", "opt_evenOdd"], ["assetId", "properties", "opt_callback"], ["sourceId", "destinationId", "opt_callback"], ["taskId", "request", "opt_callback"], ["obj"], ["opt_filter"]];
  [ee.data.getXsrfToken, ee.Geometry.LinearRing, ee.ImageCollection.prototype.getMap, ee.data.listImages, ee.data.getThumbId, ee.Dictionary, ee.Geometry.prototype.toGeoJSONString, ee.batch.Export.table.toCloudStorage, ee.data.getTaskListWithLimit, ee.Geometry.Polygon, ee.initialize, ee.data.startProcessing, ee.Deserializer.decode, ee.data.newTaskId, ee.ComputedObject.prototype.aside, ee.ApiFunction.lookup, ee.Function.prototype.apply, ee.Image.prototype.getMap, ee.ImageCollection.prototype.getInfo, 
  ee.data.createAssetHome, ee.Filter.or, ee.Image.prototype.select, ee.data.authenticateViaOauth, ee.Collection.prototype.filter, ee.Filter.metadata, ee.List, ee.Geometry.LineString, ee.data.getTaskStatus, ee.FeatureCollection.prototype.getMap, ee.data.clearAuthToken, ee.FeatureCollection.prototype.getInfo, ee.Feature.prototype.getInfo, ee.data.setCloudApiEnabled, ee.Image.prototype.getDownloadURL, ee.data.getCloudApiEnabled, ee.Collection.prototype.map, ee.Filter.gt, ee.ApiFunction._apply, ee.ImageCollection.prototype.select, 
  ee.data.getTileUrl, ee.batch.Export.video.toDrive, ee.batch.Export.image.toDrive, ee.data.getList, ee.data.getDownloadId, ee.ImageCollection.prototype.getVideoThumbURL, ee.Terrain, ee.Collection.prototype.limit, ee.data.authenticate, ee.data.getAuthScopes, ee.Deserializer.fromJSON, ee.data.getVideoThumbId, ee.String, ee.Date, ee.batch.Export.videoMap.toCloudStorage, ee.Serializer.encodeCloudApiPretty, ee.data.createFolder, ee.batch.Export.table.toAsset, ee.data.startTableIngestion, ee.data.setDeadline, 
  ee.Filter.and, ee.data.getAssetRoots, ee.Geometry.prototype.toGeoJSON, ee.data.getAsset, ee.Filter.lte, ee.data.getAuthClientId, ee.ComputedObject.prototype.serialize, ee.Filter.eq, ee.Algorithms, ee.Geometry.MultiPoint, ee.Image.prototype.rename, ee.data.getValue, ee.data.getMapId, ee.data.updateAsset, ee.data.copyAsset, ee.Function.prototype.call, ee.ImageCollection, ee.FeatureCollection, ee.data.makeTableDownloadUrl, ee.data.cancelOperation, ee.InitState, ee.data.setApiKey, ee.Serializer.toReadableJSON, 
  ee.Geometry.Rectangle, ee.Filter.lt, ee.data.createAsset, ee.data.withProfiling, ee.ComputedObject.prototype.getInfo, ee.Number, ee.batch.Export.image.toAsset, ee.data.setParamAugmenter, ee.Image.cat, ee.data.listAssets, ee.Filter.prototype.not, ee.Collection.prototype.filterMetadata, ee.data.updateTask, ee.data.setProject, ee.data.getTileBaseUrl, ee.Image, ee.data.makeDownloadUrl, ee.ImageCollection.prototype.first, ee.data.getTableDownloadId, ee.data.makeThumbUrl, ee.Filter.bounds, ee.data.setAuthTokenRefresher, 
  ee.data.setAuthToken, ee.Image.prototype.expression, ee.data.getTaskList, ee.data.authenticateViaPrivateKey, ee.Collection.prototype.iterate, ee.data.getInfo, ee.data.getAuthToken, ee.Filter.gte, ee.Image.rgb, ee.FeatureCollection.prototype.getDownloadURL, ee.ComputedObject.prototype.evaluate, ee.batch.Export.map.toCloudStorage, ee.batch.Export.video.toCloudStorage, ee.batch.Export.table.toDrive, ee.data.getFilmstripThumbId, ee.data.listBuckets, ee.TILE_SIZE, ee.reset, ee.Geometry.MultiPolygon, 
  ee.Collection.prototype.filterBounds, ee.data.getOperation, ee.data.getAssetRootQuota, ee.Geometry.MultiLineString, ee.Element.prototype.set, ee.Feature.prototype.getMap, ee.data.setAssetAcl, ee.data.cancelTask, ee.Serializer.encodeCloudApi, ee.Image.prototype.clip, ee.Image.prototype.getThumbURL, ee.ApiFunction._call, ee.Image.prototype.getInfo, ee.Feature, ee.Geometry.Point, ee.Serializer.encode, ee.Geometry.prototype.serialize, ee.call, ee.data.getApiBaseUrl, ee.Filter.date, ee.Collection.prototype.sort, 
  ee.Filter.inList, ee.Collection.prototype.filterDate, ee.data.getAssetAcl, ee.data.setExpressionAugmenter, ee.batch.Export.image.toCloudStorage, ee.Serializer.toReadableCloudApiJSON, ee.data.authenticateViaPopup, ee.apply, ee.ImageCollection.prototype.getFilmstripThumbURL, ee.Filter.neq, ee.data.deleteAsset, ee.FeatureCollection.prototype.select, ee.Geometry, ee.data.setAssetProperties, ee.data.renameAsset, ee.data.startIngestion, ee.Serializer.toJSON, ee.Filter].forEach(function(fn, i) {
