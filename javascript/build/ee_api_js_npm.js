...
ee.batch.Export.image.toAsset = function(image, opt_description, opt_assetId, opt_pyramidingPolicy, opt_dimensions, opt_region, opt_scale, opt_crs, opt_crsTransform, opt_maxPixels) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.image.toAsset, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.ASSET);
...
ee.batch.Export.image.toCloudStorage = function(image, opt_description, opt_bucket, opt_fileNamePrefix, opt_dimensions, opt_region, opt_scale, opt_crs, opt_crsTransform, opt_maxPixels, opt_shardSize, opt_fileDimensions, opt_skipEmptyTiles, opt_fileFormat, opt_formatOptions) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.image.toCloudStorage, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.GCS);
...
ee.batch.Export.image.toDrive = function(image, opt_description, opt_folder, opt_fileNamePrefix, opt_dimensions, opt_region, opt_scale, opt_crs, opt_crsTransform, opt_maxPixels, opt_shardSize, opt_fileDimensions, opt_skipEmptyTiles, opt_fileFormat, opt_formatOptions) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.image.toDrive, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.DRIVE);
  serverConfig = ee.batch.Export.reconcileImageFormat(serverConfig);
  return ee.batch.ExportTask.create(serverConfig, ee.data.ExportType.IMAGE);
};
ee.batch.Export.map.toCloudStorage = function(image, opt_description, opt_bucket, opt_fileFormat, opt_path, opt_writePublicTiles, opt_scale, opt_maxZoom, opt_minZoom, opt_region, opt_skipEmptyTiles) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.map.toCloudStorage, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.GCS);
...
ee.batch.Export.table.toCloudStorage = function(collection, opt_description, opt_bucket, opt_fileNamePrefix, opt_fileFormat, opt_selectors) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.table.toCloudStorage, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.GCS);
...
ee.batch.Export.table.toDrive = function(collection, opt_description, opt_folder, opt_fileNamePrefix, opt_fileFormat, opt_selectors) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.table.toDrive, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.DRIVE);
  return ee.batch.ExportTask.create(serverConfig, ee.data.ExportType.TABLE);
};
ee.batch.Export.table.toAsset = function(collection, opt_description, opt_assetId) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.table.toAsset, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.ASSET);
  return ee.batch.ExportTask.create(serverConfig, ee.data.ExportType.TABLE);
};
ee.batch.Export.video.toCloudStorage = function(collection, opt_description, opt_bucket, opt_fileNamePrefix, opt_framesPerSecond, opt_dimensions, opt_region, opt_scale, opt_crs, opt_crsTransform, opt_maxPixels, opt_maxFrames) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.video.toCloudStorage, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.GCS);
...
ee.batch.Export.video.toDrive = function(collection, opt_description, opt_folder, opt_fileNamePrefix, opt_framesPerSecond, opt_dimensions, opt_region, opt_scale, opt_crs, opt_crsTransform, opt_maxPixels, opt_maxFrames) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.video.toDrive, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.DRIVE);
  return ee.batch.ExportTask.create(serverConfig, ee.data.ExportType.VIDEO);
};
ee.batch.Export.videoMap.toCloudStorage = function(collection, opt_description, opt_bucket, opt_fileNamePrefix, opt_framesPerSecond, opt_writePublicTiles, opt_minZoom, opt_maxZoom, opt_scale, opt_region, opt_skipEmptyTiles) {
  var clientConfig = ee.arguments.extract(ee.batch.Export.videoMap.toCloudStorage, arguments), serverConfig = ee.batch.Export.convertToServerParams(clientConfig, ee.data.ExportDestination.GCS);
...
(function() {
  var exportedFnInfo = {}, orderedFnNames = "ee.data.makeThumbUrl ee.data.authenticateViaPrivateKey ee.data.clearAuthToken ee.data.setAuthToken ee.batch.Export.videoMap.toCloudStorage ee.ImageCollection ee.ImageCollection.prototype.getMap ee.data.getAuthScopes ee.ApiFunction._apply ee.Algorithms ee.ApiFunction.lookup ee.data.authenticateViaPopup ee.Collection.prototype.iterate ee.Feature ee.batch.Export.video.toDrive ee.Image.prototype.select ee.Geometry.Rectangle ee.data.getInfo ee.batch.Export.image.toAsset ee.TILE_SIZE ee.call ee.Geometry.prototype.toGeoJSONString ee.FeatureCollection.prototype.getDownloadURL ee.ComputedObject.prototype.aside ee.Function.prototype.apply ee.Filter.or ee.Feature.prototype.getMap ee.Collection.prototype.filterBounds ee.Filter.metadata ee.data.makeTableDownloadUrl ee.data.getThumbId ee.Dictionary ee.Feature.prototype.getInfo ee.FeatureCollection.prototype.select ee.Image.prototype.getDownloadURL ee.Collection.prototype.limit ee.data.getDownloadId ee.Filter.neq ee.Collection.prototype.filter ee.Image.prototype.getInfo ee.Image.cat ee.Filter.lte ee.Image.prototype.expression ee.Filter.bounds ee.data.setApiKey ee.ImageCollection.prototype.select ee.data.authenticate ee.Deserializer.fromJSON ee.Filter.gt ee.batch.Export.image.toDrive ee.Serializer.toJSON ee.Geometry.Point ee.data.getList ee.Image.prototype.rename ee.String ee.ComputedObject.prototype.evaluate ee.ImageCollection.prototype.getInfo ee.Filter.gte ee.Filter.lt ee.ApiFunction._call ee.data.makeDownloadUrl ee.Serializer.encode ee.Image ee.Geometry ee.Filter.inList ee.FeatureCollection.prototype.getInfo ee.Image.prototype.getMap ee.Filter ee.batch.Export.table.toDrive ee.batch.Export.image.toCloudStorage ee.Geometry.MultiPolygon ee.Geometry.MultiLineString ee.Filter.date ee.batch.Export.table.toCloudStorage ee.Filter.prototype.not ee.Geometry.prototype.toGeoJSON ee.Collection.prototype.map ee.data.getTileBaseUrl ee.Deserializer.decode ee.Filter.eq ee.Date ee.apply ee.Image.rgb ee.Geometry.LineString ee.data.getTableDownloadId ee.Number ee.data.getTileUrl ee.batch.Export.map.toCloudStorage ee.Collection.prototype.filterMetadata ee.data.getAuthClientId ee.Image.prototype.clip ee.data.setDeadline ee.Serializer.toReadableJSON ee.Terrain ee.Image.prototype.getThumbURL ee.data.authenticateViaOauth ee.reset ee.Collection.prototype.sort ee.ComputedObject.prototype.serialize ee.Geometry.Polygon ee.data.getValue ee.Geometry.prototype.serialize ee.List ee.Filter.and ee.batch.Export.table.toAsset ee.data.getMapId ee.data.setAuthTokenRefresher ee.Geometry.MultiPoint ee.data.getXsrfToken ee.Element.prototype.set ee.ComputedObject.prototype.getInfo ee.batch.Export.video.toCloudStorage ee.Function.prototype.call ee.Collection.prototype.filterDate ee.data.getAuthToken ee.data.getApiBaseUrl ee.FeatureCollection.prototype.getMap ee.Geometry.LinearRing ee.initialize ee.FeatureCollection ee.InitState".split(" "), 
  orderedParamLists = [["id"], ["privateKey", "opt_success", "opt_error", "opt_extraScopes"], [], "clientId tokenType accessToken expiresIn opt_extraScopes opt_callback opt_updateAuthLibrary".split(" "), "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_writePublicTiles opt_minZoom opt_maxZoom opt_scale opt_region opt_skipEmptyTiles".split(" "), ["args"], ["opt_visParams", "opt_callback"], [], ["name", "namedArgs"], [], ["name"], ["opt_success", "opt_error"], ["algorithm", 
  "opt_first"], ["geometry", "opt_properties"], "collection opt_description opt_folder opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), ["var_args"], ["coords", "opt_proj", "opt_geodesic", "opt_evenOdd"], ["id", "opt_callback"], "image opt_description opt_assetId opt_pyramidingPolicy opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels".split(" "), [], ["func", "var_args"], [], ["opt_format", 
  "opt_selectors", "opt_filename", "opt_callback"], ["func", "var_args"], ["namedArgs"], ["var_args"], ["opt_visParams", "opt_callback"], ["geometry"], ["name", "operator", "value"], ["id"], ["params", "opt_callback"], ["opt_dict"], ["opt_callback"], ["propertySelectors", "opt_newProperties", "opt_retainGeometry"], ["params", "opt_callback"], ["max", "opt_property", "opt_ascending"], ["params", "opt_callback"], ["name", "value"], ["newFilter"], ["opt_callback"], ["var_args"], ["name", "value"], ["expression", 
  "opt_map"], ["geometry", "opt_errorMargin"], ["apiKey"], ["selectors", "opt_names"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], ["json"], ["name", "value"], "image opt_description opt_folder opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["obj"], ["coords", "opt_proj"], ["params", "opt_callback"], ["var_args"], ["string"], 
  ["callback"], ["opt_callback"], ["name", "value"], ["name", "value"], ["name", "var_args"], ["id"], ["obj", "opt_isCompound"], ["opt_args"], ["geoJson", "opt_proj", "opt_geodesic", "opt_evenOdd"], ["opt_leftField", "opt_rightValue", "opt_rightField", "opt_leftValue"], ["opt_callback"], ["opt_visParams", "opt_callback"], ["opt_filter"], "collection opt_description opt_folder opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), "image opt_description opt_bucket opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), 
  ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["start", "opt_end"], "collection opt_description opt_bucket opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), [], [], ["algorithm", "opt_dropNulls"], [], ["json"], ["name", "value"], ["date", "opt_tz"], ["func", "namedArgs"], ["r", "g", "b"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["params", "opt_callback"], ["number"], ["mapid", "x", "y", "z"], 
  "image opt_description opt_bucket opt_fileFormat opt_path opt_writePublicTiles opt_scale opt_maxZoom opt_minZoom opt_region opt_skipEmptyTiles".split(" "), ["name", "operator", "value"], [], ["geometry"], ["milliseconds"], ["obj"], [], ["params", "opt_callback"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], [], ["property", "opt_ascending"], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["params", "opt_callback"], [], ["list"], ["var_args"], 
  ["collection", "opt_description", "opt_assetId"], ["params", "opt_callback"], ["refresher"], ["coords", "opt_proj"], [], ["var_args"], ["opt_callback"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), ["var_args"], ["start", "opt_end"], [], [], ["opt_visParams", "opt_callback"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["opt_baseurl", "opt_tileurl", 
  "opt_successCallback", "opt_errorCallback", "opt_xsrfToken"], ["args", "opt_column"], []];
  [ee.data.makeThumbUrl, ee.data.authenticateViaPrivateKey, ee.data.clearAuthToken, ee.data.setAuthToken, ee.batch.Export.videoMap.toCloudStorage, ee.ImageCollection, ee.ImageCollection.prototype.getMap, ee.data.getAuthScopes, ee.ApiFunction._apply, ee.Algorithms, ee.ApiFunction.lookup, ee.data.authenticateViaPopup, ee.Collection.prototype.iterate, ee.Feature, ee.batch.Export.video.toDrive, ee.Image.prototype.select, ee.Geometry.Rectangle, ee.data.getInfo, ee.batch.Export.image.toAsset, ee.TILE_SIZE, 
  ee.call, ee.Geometry.prototype.toGeoJSONString, ee.FeatureCollection.prototype.getDownloadURL, ee.ComputedObject.prototype.aside, ee.Function.prototype.apply, ee.Filter.or, ee.Feature.prototype.getMap, ee.Collection.prototype.filterBounds, ee.Filter.metadata, ee.data.makeTableDownloadUrl, ee.data.getThumbId, ee.Dictionary, ee.Feature.prototype.getInfo, ee.FeatureCollection.prototype.select, ee.Image.prototype.getDownloadURL, ee.Collection.prototype.limit, ee.data.getDownloadId, ee.Filter.neq, ee.Collection.prototype.filter, 
  ee.Image.prototype.getInfo, ee.Image.cat, ee.Filter.lte, ee.Image.prototype.expression, ee.Filter.bounds, ee.data.setApiKey, ee.ImageCollection.prototype.select, ee.data.authenticate, ee.Deserializer.fromJSON, ee.Filter.gt, ee.batch.Export.image.toDrive, ee.Serializer.toJSON, ee.Geometry.Point, ee.data.getList, ee.Image.prototype.rename, ee.String, ee.ComputedObject.prototype.evaluate, ee.ImageCollection.prototype.getInfo, ee.Filter.gte, ee.Filter.lt, ee.ApiFunction._call, ee.data.makeDownloadUrl, 
  ee.Serializer.encode, ee.Image, ee.Geometry, ee.Filter.inList, ee.FeatureCollection.prototype.getInfo, ee.Image.prototype.getMap, ee.Filter, ee.batch.Export.table.toDrive, ee.batch.Export.image.toCloudStorage, ee.Geometry.MultiPolygon, ee.Geometry.MultiLineString, ee.Filter.date, ee.batch.Export.table.toCloudStorage, ee.Filter.prototype.not, ee.Geometry.prototype.toGeoJSON, ee.Collection.prototype.map, ee.data.getTileBaseUrl, ee.Deserializer.decode, ee.Filter.eq, ee.Date, ee.apply, ee.Image.rgb, 
  ee.Geometry.LineString, ee.data.getTableDownloadId, ee.Number, ee.data.getTileUrl, ee.batch.Export.map.toCloudStorage, ee.Collection.prototype.filterMetadata, ee.data.getAuthClientId, ee.Image.prototype.clip, ee.data.setDeadline, ee.Serializer.toReadableJSON, ee.Terrain, ee.Image.prototype.getThumbURL, ee.data.authenticateViaOauth, ee.reset, ee.Collection.prototype.sort, ee.ComputedObject.prototype.serialize, ee.Geometry.Polygon, ee.data.getValue, ee.Geometry.prototype.serialize, ee.List, ee.Filter.and, 
  ee.batch.Export.table.toAsset, ee.data.getMapId, ee.data.setAuthTokenRefresher, ee.Geometry.MultiPoint, ee.data.getXsrfToken, ee.Element.prototype.set, ee.ComputedObject.prototype.getInfo, ee.batch.Export.video.toCloudStorage, ee.Function.prototype.call, ee.Collection.prototype.filterDate, ee.data.getAuthToken, ee.data.getApiBaseUrl, ee.FeatureCollection.prototype.getMap, ee.Geometry.LinearRing, ee.initialize, ee.FeatureCollection, ee.InitState].forEach(function(fn, i) {
