...
path:"v1alpha/{+name}:getPixels", httpMethod:"GET", parameters:{name:{location:"path", required:!0}}}}}}}}, methods:{}};
ee.rpc_proto = {};
...
(function() {
  var exportedFnInfo = {}, orderedFnNames = "ee.Serializer.toReadableCloudApiJSON ee.Image.prototype.getDownloadURL ee.Filter.date ee.data.startTableIngestion ee.data.getApiBaseUrl ee.Feature.prototype.getMap ee.Serializer.toReadableJSON ee.Image.prototype.select ee.Filter.neq ee.call ee.ApiFunction.lookup ee.data.updateAsset ee.Geometry ee.data.setDeadline ee.data.getList ee.data.listAssets ee.data.renameAsset ee.Serializer.encode ee.data.setAuthToken ee.data.setApiKey ee.data.createAsset ee.Geometry.MultiPoint ee.Filter.eq ee.data.setProject ee.Image.prototype.clip ee.String ee.data.getAuthToken ee.data.getAssetRootQuota ee.Feature ee.data.getAsset ee.data.listBuckets ee.Collection.prototype.filter ee.FeatureCollection.prototype.select ee.Geometry.Polygon ee.ImageCollection.prototype.getFilmstripThumbURL ee.FeatureCollection.prototype.getMap ee.Filter.metadata ee.Collection.prototype.sort ee.data.copyAsset ee.data.authenticateViaOauth ee.Collection.prototype.filterBounds ee.Function.prototype.apply ee.Geometry.MultiLineString ee.data.getOperation ee.data.clearAuthToken ee.Image.rgb ee.data.getThumbId ee.Geometry.prototype.toGeoJSONString ee.data.deleteAsset ee.data.cancelOperation ee.Filter ee.ImageCollection.prototype.select ee.data.getAssetAcl ee.ComputedObject.prototype.aside ee.data.setAuthTokenRefresher ee.Filter.lt ee.Filter.inList ee.Feature.prototype.getInfo ee.Filter.prototype.not ee.data.getTaskStatus ee.batch.Export.image.toCloudStorage ee.data.getTileUrl ee.data.getAuthClientId ee.data.makeDownloadUrl ee.ImageCollection ee.data.setParamAugmenter ee.Collection.prototype.iterate ee.batch.Export.map.toCloudStorage ee.data.getMapId ee.data.getTaskListWithLimit ee.Filter.gt ee.ImageCollection.prototype.getVideoThumbURL ee.Image.prototype.getMap ee.Element.prototype.set ee.Image.cat ee.data.getCloudApiEnabled ee.Filter.lte ee.Filter.or ee.Dictionary ee.Collection.prototype.limit ee.Number ee.data.listImages ee.Geometry.prototype.serialize ee.data.cancelTask ee.Geometry.prototype.toGeoJSON ee.Geometry.LinearRing ee.Terrain ee.data.createAssetHome ee.batch.Export.table.toCloudStorage ee.data.startProcessing ee.Collection.prototype.filterMetadata ee.data.getVideoThumbId ee.data.authenticate ee.apply ee.data.getTaskList ee.ComputedObject.prototype.evaluate ee.data.getAuthScopes ee.Serializer.encodeCloudApiPretty ee.TILE_SIZE ee.data.getTableDownloadId ee.Date ee.batch.Export.table.toDrive ee.data.setAssetProperties ee.batch.Export.table.toAsset ee.batch.Export.video.toDrive ee.Deserializer.fromJSON ee.data.setAssetAcl ee.data.updateTask ee.data.getDownloadId ee.data.getValue ee.InitState ee.data.setExpressionAugmenter ee.reset ee.data.withProfiling ee.Deserializer.decode ee.Serializer.encodeCloudApi ee.batch.Export.video.toCloudStorage ee.data.authenticateViaPopup ee.ApiFunction._apply ee.Collection.prototype.map ee.Filter.gte ee.ComputedObject.prototype.serialize ee.data.setCloudApiEnabled ee.ImageCollection.prototype.getMap ee.data.getInfo ee.Image.prototype.rename ee.Image.prototype.getInfo ee.Serializer.toJSON ee.Image ee.data.newTaskId ee.Filter.and ee.data.authenticateViaPrivateKey ee.Collection.prototype.filterDate ee.Image.prototype.expression ee.data.makeThumbUrl ee.ComputedObject.prototype.getInfo ee.List ee.Function.prototype.call ee.data.getTileBaseUrl ee.data.getFilmstripThumbId ee.data.getAssetRoots ee.Geometry.LineString ee.Geometry.MultiPolygon ee.batch.Export.image.toAsset ee.FeatureCollection.prototype.getInfo ee.FeatureCollection ee.ImageCollection.prototype.getInfo ee.data.getXsrfToken ee.Geometry.Point ee.Filter.bounds ee.Geometry.Rectangle ee.batch.Export.videoMap.toCloudStorage ee.data.createFolder ee.batch.Export.image.toDrive ee.data.makeTableDownloadUrl ee.FeatureCollection.prototype.getDownloadURL ee.ApiFunction._call ee.Image.prototype.getThumbURL ee.initialize ee.data.startIngestion ee.ImageCollection.prototype.first ee.Algorithms".split(" "), 
  orderedParamLists = [["obj"], ["params", "opt_callback"], ["start", "opt_end"], ["taskId", "request", "opt_callback"], [], ["opt_visParams", "opt_callback"], ["obj"], ["var_args"], ["name", "value"], ["func", "var_args"], ["name"], ["assetId", "asset", "updateMask", "opt_callback"], ["geoJson", "opt_proj", "opt_geodesic", "opt_evenOdd"], ["milliseconds"], ["params", "opt_callback"], ["body", "opt_callback"], ["sourceId", "destinationId", "opt_callback"], ["obj", "opt_isCompound"], "clientId tokenType accessToken expiresIn opt_extraScopes opt_callback opt_updateAuthLibrary".split(" "), 
  ["apiKey"], ["value", "opt_path", "opt_force", "opt_properties", "opt_callback"], ["coords", "opt_proj"], ["name", "value"], ["project"], ["geometry"], ["string"], [], ["rootId", "opt_callback"], ["geometry", "opt_properties"], ["id", "opt_callback"], ["opt_callback"], ["filter"], ["propertySelectors", "opt_newProperties", "opt_retainGeometry"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], ["params", "opt_callback"], ["opt_visParams", "opt_callback"], ["name", "operator", 
  "value"], ["property", "opt_ascending"], ["sourceId", "destinationId", "opt_overwrite", "opt_callback"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], ["geometry"], ["namedArgs"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["operationName", "opt_callback"], [], ["r", "g", "b"], ["params", "opt_callback"], [], ["assetId", "opt_callback"], ["operationName", "opt_callback"], ["opt_filter"], ["selectors", "opt_names"], ["assetId", "opt_callback"], ["func", 
  "var_args"], ["refresher"], ["name", "value"], ["opt_leftField", "opt_rightValue", "opt_rightField", "opt_leftValue"], ["opt_callback"], [], ["taskId", "opt_callback"], "image opt_description opt_bucket opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["mapid", "x", "y", "z"], [], ["id"], ["args"], ["augmenter"], ["algorithm", "opt_first"], "image opt_description opt_bucket opt_fileFormat opt_path opt_writePublicTiles opt_scale opt_maxZoom opt_minZoom opt_region opt_skipEmptyTiles opt_mapsApiKey".split(" "), 
  ["params", "opt_callback"], ["opt_limit", "opt_callback"], ["name", "value"], ["params", "opt_callback"], ["opt_visParams", "opt_callback"], ["var_args"], ["var_args"], [], ["name", "value"], ["var_args"], ["opt_dict"], ["max", "opt_property", "opt_ascending"], ["number"], ["body", "opt_callback"], [], ["taskId", "opt_callback"], [], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], [], ["requestedId", "opt_callback"], "collection opt_description opt_bucket opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), 
  ["taskId", "params", "opt_callback"], ["name", "operator", "value"], ["params", "opt_callback"], ["clientId", "success", "opt_error", "opt_extraScopes", "opt_onImmediateFailed"], ["func", "namedArgs"], ["opt_callback"], ["callback"], [], ["obj"], [], ["params", "opt_callback"], ["date", "opt_tz"], "collection opt_description opt_folder opt_fileNamePrefix opt_fileFormat opt_selectors".split(" "), ["assetId", "properties", "opt_callback"], ["collection", "opt_description", "opt_assetId"], "collection opt_description opt_folder opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), 
  ["json"], ["assetId", "aclUpdate", "opt_callback"], ["taskId", "action", "opt_callback"], ["params", "opt_callback"], ["params", "opt_callback"], [], ["augmenter"], [], ["hook", "body", "opt_this"], ["json"], ["obj"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_maxFrames".split(" "), ["opt_success", "opt_error"], ["name", "namedArgs"], ["algorithm", "opt_dropNulls"], ["name", "value"], 
  [], ["enable"], ["opt_visParams", "opt_callback"], ["id", "opt_callback"], ["var_args"], ["opt_callback"], ["obj"], ["opt_args"], ["opt_count", "opt_callback"], ["var_args"], ["privateKey", "opt_success", "opt_error", "opt_extraScopes"], ["start", "opt_end"], ["expression", "opt_map"], ["id"], ["opt_callback"], ["list"], ["var_args"], [], ["params", "opt_callback"], ["opt_callback"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError"], ["coords", "opt_proj", "opt_geodesic", "opt_maxError", "opt_evenOdd"], 
  "image opt_description opt_assetId opt_pyramidingPolicy opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels".split(" "), ["opt_callback"], ["args", "opt_column"], ["opt_callback"], [], ["coords", "opt_proj"], ["geometry", "opt_errorMargin"], ["coords", "opt_proj", "opt_geodesic", "opt_evenOdd"], "collection opt_description opt_bucket opt_fileNamePrefix opt_framesPerSecond opt_writePublicTiles opt_minZoom opt_maxZoom opt_scale opt_region opt_skipEmptyTiles".split(" "), ["path", 
  "opt_force", "opt_callback"], "image opt_description opt_folder opt_fileNamePrefix opt_dimensions opt_region opt_scale opt_crs opt_crsTransform opt_maxPixels opt_shardSize opt_fileDimensions opt_skipEmptyTiles opt_fileFormat opt_formatOptions".split(" "), ["id"], ["opt_format", "opt_selectors", "opt_filename", "opt_callback"], ["name", "var_args"], ["params", "opt_callback"], ["opt_baseurl", "opt_tileurl", "opt_successCallback", "opt_errorCallback", "opt_xsrfToken"], ["taskId", "request", "opt_callback"], 
  [], []];
  [ee.Serializer.toReadableCloudApiJSON, ee.Image.prototype.getDownloadURL, ee.Filter.date, ee.data.startTableIngestion, ee.data.getApiBaseUrl, ee.Feature.prototype.getMap, ee.Serializer.toReadableJSON, ee.Image.prototype.select, ee.Filter.neq, ee.call, ee.ApiFunction.lookup, ee.data.updateAsset, ee.Geometry, ee.data.setDeadline, ee.data.getList, ee.data.listAssets, ee.data.renameAsset, ee.Serializer.encode, ee.data.setAuthToken, ee.data.setApiKey, ee.data.createAsset, ee.Geometry.MultiPoint, ee.Filter.eq, 
  ee.data.setProject, ee.Image.prototype.clip, ee.String, ee.data.getAuthToken, ee.data.getAssetRootQuota, ee.Feature, ee.data.getAsset, ee.data.listBuckets, ee.Collection.prototype.filter, ee.FeatureCollection.prototype.select, ee.Geometry.Polygon, ee.ImageCollection.prototype.getFilmstripThumbURL, ee.FeatureCollection.prototype.getMap, ee.Filter.metadata, ee.Collection.prototype.sort, ee.data.copyAsset, ee.data.authenticateViaOauth, ee.Collection.prototype.filterBounds, ee.Function.prototype.apply, 
  ee.Geometry.MultiLineString, ee.data.getOperation, ee.data.clearAuthToken, ee.Image.rgb, ee.data.getThumbId, ee.Geometry.prototype.toGeoJSONString, ee.data.deleteAsset, ee.data.cancelOperation, ee.Filter, ee.ImageCollection.prototype.select, ee.data.getAssetAcl, ee.ComputedObject.prototype.aside, ee.data.setAuthTokenRefresher, ee.Filter.lt, ee.Filter.inList, ee.Feature.prototype.getInfo, ee.Filter.prototype.not, ee.data.getTaskStatus, ee.batch.Export.image.toCloudStorage, ee.data.getTileUrl, ee.data.getAuthClientId, 
  ee.data.makeDownloadUrl, ee.ImageCollection, ee.data.setParamAugmenter, ee.Collection.prototype.iterate, ee.batch.Export.map.toCloudStorage, ee.data.getMapId, ee.data.getTaskListWithLimit, ee.Filter.gt, ee.ImageCollection.prototype.getVideoThumbURL, ee.Image.prototype.getMap, ee.Element.prototype.set, ee.Image.cat, ee.data.getCloudApiEnabled, ee.Filter.lte, ee.Filter.or, ee.Dictionary, ee.Collection.prototype.limit, ee.Number, ee.data.listImages, ee.Geometry.prototype.serialize, ee.data.cancelTask, 
  ee.Geometry.prototype.toGeoJSON, ee.Geometry.LinearRing, ee.Terrain, ee.data.createAssetHome, ee.batch.Export.table.toCloudStorage, ee.data.startProcessing, ee.Collection.prototype.filterMetadata, ee.data.getVideoThumbId, ee.data.authenticate, ee.apply, ee.data.getTaskList, ee.ComputedObject.prototype.evaluate, ee.data.getAuthScopes, ee.Serializer.encodeCloudApiPretty, ee.TILE_SIZE, ee.data.getTableDownloadId, ee.Date, ee.batch.Export.table.toDrive, ee.data.setAssetProperties, ee.batch.Export.table.toAsset, 
  ee.batch.Export.video.toDrive, ee.Deserializer.fromJSON, ee.data.setAssetAcl, ee.data.updateTask, ee.data.getDownloadId, ee.data.getValue, ee.InitState, ee.data.setExpressionAugmenter, ee.reset, ee.data.withProfiling, ee.Deserializer.decode, ee.Serializer.encodeCloudApi, ee.batch.Export.video.toCloudStorage, ee.data.authenticateViaPopup, ee.ApiFunction._apply, ee.Collection.prototype.map, ee.Filter.gte, ee.ComputedObject.prototype.serialize, ee.data.setCloudApiEnabled, ee.ImageCollection.prototype.getMap, 
  ee.data.getInfo, ee.Image.prototype.rename, ee.Image.prototype.getInfo, ee.Serializer.toJSON, ee.Image, ee.data.newTaskId, ee.Filter.and, ee.data.authenticateViaPrivateKey, ee.Collection.prototype.filterDate, ee.Image.prototype.expression, ee.data.makeThumbUrl, ee.ComputedObject.prototype.getInfo, ee.List, ee.Function.prototype.call, ee.data.getTileBaseUrl, ee.data.getFilmstripThumbId, ee.data.getAssetRoots, ee.Geometry.LineString, ee.Geometry.MultiPolygon, ee.batch.Export.image.toAsset, ee.FeatureCollection.prototype.getInfo, 
  ee.FeatureCollection, ee.ImageCollection.prototype.getInfo, ee.data.getXsrfToken, ee.Geometry.Point, ee.Filter.bounds, ee.Geometry.Rectangle, ee.batch.Export.videoMap.toCloudStorage, ee.data.createFolder, ee.batch.Export.image.toDrive, ee.data.makeTableDownloadUrl, ee.FeatureCollection.prototype.getDownloadURL, ee.ApiFunction._call, ee.Image.prototype.getThumbURL, ee.initialize, ee.data.startIngestion, ee.ImageCollection.prototype.first, ee.Algorithms].forEach(function(fn, i) {
